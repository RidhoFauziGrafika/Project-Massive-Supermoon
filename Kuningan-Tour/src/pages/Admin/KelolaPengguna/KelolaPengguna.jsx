            ...
            <div className="px-4 py-6">
              ...
              <div className="mt-5">
                ...
                <div className="overflow-x-auto mt-5">
                  <table className="min-w-full border text-center text-sm font-light border-neutral-50">
                    ...
                    <tbody>
                      <tr className="border-b border-neutral-50">
                        <td className="whitespace-nowrap border-r px-6 py-4 font-medium border-neutral-50">
                          1
                        </td>
                        <td className="whitespace-nowrap border-r px-6 py-4 border-neutral-50">
                          Admin
                        </td>
                        <td className="whitespace-nowrap border-r px-6 py-4 border-neutral-50">
                          Administrator
                        ...
                        <td className="flex justify-center items-center gap-3 mt-3">
                          ...
                          <Link className="px-4 py-2 bg-[#FD3550] text-white rounded-lg">
                            <FaTrashCan />
                          </Link>
                        </td>
                      </tr>
