          ...
          <div className="w-full bg-neutral-10 rounded-lg mb-10 px-4 py-8">
            <div className="px-4 py-6">
              <div className="flex flex-col lg:flex-row lg:justify-between items-center">
                <h4 className="lg:text-4xl text-xl font-bold">Kelola Wisata</h4>
                <Link
                  to="/dashboard/formWisata"
                  ...
                  <table className="min-w-full border  text-sm font-light border-neutral-50">
                    ...
                    <tbody>
                      <tr className="border-b border-neutral-50">
                        ...
                        <td className="border-r px-6 py-4 border-neutral-50">
                          Sidomba, terkenal sebagai tujuan wisata di Kuningan,
                          sering dijadikan tempat berkemah oleh berbagai
                          lembaga.
                        </td>
