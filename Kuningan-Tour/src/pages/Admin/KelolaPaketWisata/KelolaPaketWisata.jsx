            ...
            <div className="px-4 py-6">
              <div className="flex flex-col lg:flex-row lg:justify-between items-center">
                ...
                <Link
                  ...
                  className="flex gap-3 items-center px-2 py-1 lg:px-4 lg:py-2 lg:text-base text-sm text-center text-white border-solid  bg-primary-main rounded-lg"
                >
                  <FaPlus />
                  Tambah Paket Wisata
                </Link>
                  ...
                  <table className="min-w-full border  text-sm font-light border-neutral-50">
                    ...
                    <tbody>
                      <tr className="border-b border-neutral-50">
                        ...
                        <td className="border-r px-6 py-4 border-neutral-50">
                          Paket wisata ini dibuat untuk memudahkan para
                          wisatawan dalam merencanakan liburan di kabupaten
                          kuningan. paket wisata ini terdiri dari kunjungan
                          beberapa tempat wisata. Serta mendapatkan kuliner dan
                          penginapan jika membeli paket wisata kuningan.
                        </td>
                        <td className="flex justify-center items-center gap-3 mt-3 px-3">
                          <button className="px-4 py-2 bg-[#0D6EFD] text-white rounded-lg">
                            <BiSolidPencil />
                          </button>
...
export default KelolaPaketWisata;
