          ...
          <div className="p-2 row-span-3">
            <div className="w-[320px] h-[700px] bg-neutral-card rounded-lg drop-shadow-xl">
              ...
              <img src={Logo} className="w-[200px] self-center" alt="image" />
                ...
                <Link to="/profile" className="flex flex-row px-4 py-2 my-6 text-lg rounded-lg text-white bg-primary-main">
                ...
                <Link to="/setting" className="flex flex-row px-4 py-2 my-6 text-lg rounded-lg">
            ...
            <div className="my-4">
              ...
              <form>
                <div className="m-4 relative flex items-center gap-2">
                  ...
                  />
                  <button className="px-4 py-2 my-6 mx-3 text-lg rounded-lg text-white bg-primary-main">Cari</button>
                </div>
              </form>
              ...
              <div className="mx-4 flex flex-row justify-between">
                ...
                <button className="flex justify-end text-lg tracking-tight text-gray-900">
                  Lihat Semua
                </button>
              </div>              
            </div>
