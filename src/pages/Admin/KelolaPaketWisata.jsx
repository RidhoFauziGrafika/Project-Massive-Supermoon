        ...
        <div className="p-2 row-span-3">
          <div className="w-[320px] h-[750px] bg-neutral-card rounded-lg drop-shadow-xl">
            ...
            <img src={Logo} className="w-[200px] self-center" alt="image" />
              ...
              <Link to="/kelolapaketwisata" className="flex flex-row px-4 py-2 my-3 text-lg rounded-lg text-white bg-primary-main">
          ...
          <div className="m-8">
            <div className="my-5">
              ...
              <div className="relative flex items-center gap-2">
                <input type="text" name="search" placeholder="Nama Paket Wisata" autoComplete="off" 
            ...
            <div className="my-5">
              ...
              <div className="relative flex items-center gap-2">
                <input type="text" name="search" placeholder="Link Google Maps" autoComplete="off" 
                  className="w-full p-2 pl-3 placeholder-neutral-70 rounded-xl border-2" />
              </div>
            </div>
            <div className="my-5">
            ...
            <div className="my-5">
            <input type="text" name="search" placeholder="Isi Artikel Paket Wisata" autoComplete="off" 
              className="w-full h-[500px] p-2 pl-3 placeholder-neutral-70 rounded-xl border-2" />
            </div>
            <input type="file" className="my-5 block text-sm text-slate-500 file:mr-4 file:py-2
