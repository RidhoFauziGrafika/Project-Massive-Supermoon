        ...
        <div className="p-2 row-span-3">
          <div className="w-[320px] h-[750px] bg-neutral-card rounded-lg drop-shadow-xl">
            ...
            <img src={Logo} className="w-[200px] self-center" alt="image" />
              ...
              <Link to="/kelolawisata" className="flex flex-row px-4 py-2 my-3 text-lg rounded-lg text-white bg-primary-main">
          ...
          <div className="m-8">
            <div className="my-5">
              ...
              <div className="relative flex items-center gap-2">
                <input type="text" name="search" placeholder="Nama Wisata" autoComplete="off" 
