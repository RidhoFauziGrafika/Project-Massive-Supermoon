        ...
        <div className="w-[328px] bg-neutral-card rounded-lg drop-shadow-xl">
          ...
          <div className="p-5">
            ...
            <div className="flex flex-row justify-between p-3">
              ...
              <Link to="/detail" className="inline-flex items-center px-4 py-2 text-[16px]  text-center text-primary-main border-solid border-2 border-primary-main bg-primary-surface rounded-lg">
                Detail
              </Link>
            </div>
          </div>
